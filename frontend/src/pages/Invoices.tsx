            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                <div className="card p-6 xl:col-span-2 space-y-5">
                    ...
                    <div className="space-y-3">
                        <div className="grid grid-cols-[1fr_90px_140px_44px] gap-2 text-sm font-semibold text-muted px-1">
                        ...
                        {lines.map((line, index) => (
                            <div key={index} className="grid grid-cols-[1fr_90px_140px_44px] gap-2">
                                <input
                                    type="text"
